...
public class Constants {
     ...
     * GDT AD INFO
     */
    public static final boolean ENABLE_GDT_AD = false;
    public static final String GDT_APPId = "1101981396";
    public static final String GDT_SplashPosId = "9079537212388877351";
    ...
    public static final String DuoMeng_SpotId = "16TLuVtvApvQsNU0X9aCp7fz";
